...
<head>
    ...
    {{-- Mobile bottom bar (CSS + JS) --}}
    @includeIf('theme::components.front_mobile_bottom_bar_assets')
    @includeIf('components.front_mobile_bottom_bar_assets')
...
<body class="td_theme_2">
    ...
    @stack('js_section')
    {{-- Mobile bottom bar (markup) --}}
    @includeIf('theme::components.front_mobile_bottom_bar')
