...
@section('body-header')
    ...
    <p class="crancy-header__text">{{ __('translate.Dashboard') }} >> {{ __('translate.Edit Brand') }}</p>
@endsection
                    ...
                    <div class="crancy-body">
                        ...
                        <div class="crancy-dsinner">
                            <form action="{{ route('admin.brand.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="lang_code" value="{{ $brand_translate->lang_code }}">
                                <input type="hidden" name="translate_id" value="{{ $brand_translate->id }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="name" id="name" value="{{ $brand_translate->name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="slug" id="slug" value="{{ $brand->slug }}">
                                                    </div>
                                                </div>
