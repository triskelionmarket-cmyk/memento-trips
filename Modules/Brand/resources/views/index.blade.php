...
@section('body-header')
    ...
    <p class="crancy-header__text">{{ __('translate.Dashboard') }} >> {{ __('translate.Brand List') }}</p>
@endsection
                                        ...
                                        <tbody class="crancy-table__body">
                                            @foreach ($brands as $index => $brand)
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">{{ $brand->translate?->name }}</h4>
                                                    </td>
...
@push('js_section')
    <script>
        ...
        function itemDeleteConfrimation(id){
            $("#item_delect_confirmation").attr("action",'{{ url("admin/brand/") }}'+"/"+id)
        }
    </script>
@endpush
