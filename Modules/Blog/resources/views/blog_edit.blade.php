                                        ...
                                        <div class="translation_box">
                                            <ul>
                                                @foreach ($language_list as $language)
                                                    <li><a
                                                            href="{{ route('admin.blog.edit', ['blog' => $blog->id, 'lang_code' => $language->lang_code]) }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                ...
                                                <a href="{{ route('admin.blog.index') }}" class="crancy-btn "><i
                                                        class="fa fa-list"></i> {{ __('translate.Blog List') }}</a>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="title"
                                                            id="title" value="{{ $blog_translate->title }}">
                                                    </div>
                                                </div>
                                                ...
                                                @if (admin_lang() == request()->get('lang_code'))
                                                    ...
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            <label
                                                                class="crancy__item-label">{{ __('translate.Category') }} *
                                                            </label>
                                                            <select class="form-select crancy__item-input" name="category">
                                                                <option value="">
                                                                    {{ __('translate.Select Category') }}</option>
                                                                @foreach ($blog_categories as $blog_category)
                                                                    <option
                                                                        {{ $blog_category->id == $blog->blog_category_id ? 'selected' : '' }}
                                                                        value="{{ $blog_category->id }}">
                                                                        {{ $blog_category->translate->name }}</option>
                                                                @endforeach
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <label class="crancy__item-label">{{ __('translate.Reading time') }}</label>
                                                        <input class="crancy__item-input" type="text" name="reading_time"
                                                            id="reading_time" value="{{ $blog_translate->reading_time }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <label
                                                            class="crancy__item-label">{{ __('translate.Short Description') }}
                                                            *</label>

                                                        <textarea class="crancy__item-input crancy__item-textarea seo_description_box" name="short_description"
                                                            id="short_description">{{ $blog_translate->short_description }}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                @if (admin_lang() == request()->get('lang_code'))
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            <label
                                                                class="crancy__item-label">{{ __('translate.Visibility Status') }}
                                                            </label>
                                                            <div
                                                                class="crancy-ptabs__notify-switch  crancy-ptabs__notify-switch--two">
                                                                <label class="crancy__item-switch">
                                                                    <input {{ $blog->status == 1 ? 'checked' : '' }}
                                                    ...
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            <label class="crancy__item-label">{{ __('translate.Tags') }}
                                                            </label>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <label class="crancy__item-label">{{ __('translate.SEO Title') }}
                                                        </label>
                                                        <input class="crancy__item-input" type="text" name="seo_title"
                                                            id="seo_title" value="{{ $blog_translate->seo_title }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <label
                                                            class="crancy__item-label">{{ __('translate.SEO Description') }}
                                                        </label>

                                                        <textarea class="crancy__item-input crancy__item-textarea seo_description_box" name="seo_description"
                                                            id="seo_description">{{ $blog_translate->seo_description }}</textarea>
                                                    </div>
                                                </div>
