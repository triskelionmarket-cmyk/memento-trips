 ...
 * BlogController
 *
 * Admin CRUD for blog posts with image uploads, SEO fields, category assignment, and multi-language translations.
 *
 * @package Modules\Blog\App\Http\Controllers
 */
class BlogController extends Controller
{
    ...
    public function store(BlogRequest $request)
    {
        ...
        foreach ($languages as $language) {
            ...
            $blog_trans->reading_time = $request->reading_time;
